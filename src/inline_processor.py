...
def text_to_textnodes(text):
    ...
    italic_processed = split_nodes_delimiter(
        alternative_bold_processed, "*", TextType.ITALIC
    )
    alternative_italic_processed = split_nodes_delimiter(
        italic_processed, "_", TextType.ITALIC
    )
